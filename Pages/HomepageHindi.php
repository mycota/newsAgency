...
<?php		
	 ...
	 if(isset($_GET["s"])){
		...
		$query = "select * from tbl_news_h order by date_published desc Limit ".$page1.",3;";
	}	 
	$select_post = mysqli_query($connection, $query);
...
<div class="news" id='cb<?php echo $post_id; ?>'>
	<div class="container">
		...
		<a href="CommentHindi.php?news=<?php echo $post_id; ?>"><img name="image" id="image" style="box-shadow: 3px 3px 3px gray;" src="../editor/resource/images/newsimage/<?php echo $post_image; ?>" alt=""></a>
