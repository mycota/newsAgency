                      ...
                      if (isset($_GET['edit'])) {
                          $advert_id = mysqli_real_escape_string($connection,$_GET['edit']);            
                    ...
                    $adver_id = mysqli_real_escape_string($connection,$row['advert_id']);
                    $advert_name = mysqli_real_escape_string($connection,$row['advert_name']);
                    $detail = mysqli_real_escape_string($connection,$row['advert_detail']);
                    ...
                    $advert_name = mysqli_real_escape_string($connection,$_POST['advert_name']);
                    $advert_detail = mysqli_real_escape_string($connection,$_POST['advert_detail']);
