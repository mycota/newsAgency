...
<input class="form-control" id="myInput" type="text" placeholder="Search..">
  ...
  $page = mysqli_real_escape_string($connection,$_GET['page']);
    ...
    $query_count = "SELECT * from tbl_news, tbl_image, tbl_news_category, tbl_employee where authorid = id and categoryID = newscat_id and img_id = image_id ";
...
<table class="table table-bordered table-hover">
  ...
  $query = "SELECT DISTINCT * from tbl_news, tbl_image, tbl_news_category, tbl_employee where authorid = id and categoryID = newscat_id and img_id = image_id order by newss_id LIMIT $page1,4";
