...
<input class="form-control" id="myInput" type="text" placeholder="Search..">
  ...
  $page = mysqli_real_escape_string($connection,$_GET['page']);
    ...
    $query_count = "select * from tbl_news, tbl_employee, tbl_comments where newss_id = comment_news_id and email = '$username' and authorid = id";
...
<table class="table table-bordered table-hover">
        ...
        <?php 
       $username = $_SESSION['username'];      
       $query = "SELECT * from tbl_news, tbl_employee, tbl_comments where newss_id = comment_news_id and email = '$username' and authorid = id order by comment_id desc LIMIT $page1,4";
