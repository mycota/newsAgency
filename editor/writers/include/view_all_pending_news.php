...
<input class="form-control" id="myInput" type="text" placeholder="Search..">
  ...
  $page = $_GET['page'];
    ...
    $query_count = "SELECT * FROM tbl_news, tbl_image, tbl_news_category, tbl_employee where authorid = id and email = '$username' and categoryID = newscat_id and img_id = image_id and '$cdate' < date_published";
...
<table class="table table-bordered table-hover">
  ...
  $cdate = date("Y-m-d");
  $query = "SELECT * from tbl_news, tbl_image, tbl_news_category, tbl_employee where authorid = id and email = '$username' and categoryID = newscat_id and img_id = image_id and '$cdate' < date_published order by date_published LIMIT $page1,5";
