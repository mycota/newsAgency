...
if (isset($_POST['add_draft'])) {
    ...
    $query = "insert into tbl_draft_news (tittle,description,details,authorid,categoryID,language,draft_status,draft_user,imge_id)";
    $query .= "value ('$title','$news_discrpt','$news_content','$empid','$newscat','$lang','Drafting','$username','$last_image_id')";
    ...
    //$done.= "News successfully saved: ". " ". "<a href='news.php'>Submit to Editor</a> ";
                    //news.php?source=compose_news
...
<form action="" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
		...
		<textarea class="form-control" name="news_discrpt" id="" cols="30" rows="5"></textarea>
	</div>
<!-- </div>
