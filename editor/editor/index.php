...
<!-- <h2>NEWS</h2> -->
    ...
    <div class="col-lg-4 col-md-6">
        <div class="panel panel-primary">
            ...
            <?php
            $query = "SELECT * FROM tbl_news, tbl_image, tbl_news_category, tbl_employee where email = '$username' and editorid = id and categoryID = newscat_id and img_id = image_id and '$cdate' < end_date and '$cdate' > date_published";
        ...
        <div class="panel panel-green">
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-xs-9 text-right">
                     <?php
            $query = "SELECT * from tbl_news, tbl_image, tbl_news_category, tbl_employee where email = '$username' and editorid = id and categoryID = newscat_id and img_id = image_id and '$cdate' < date_published";
            $select_query = mysqli_query($connection, $query);
        ...
        <div class="panel panel-yellow">
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-xs-9 text-right">
                    <?php
            $query = "SELECT * from tbl_news, tbl_image, tbl_news_category, tbl_employee where email = '$username' and editorid = id and categoryID = newscat_id and img_id = image_id and '$cdate' > end_date";
            $select_query = mysqli_query($connection, $query);
        ...
        <div class="panel panel-red">
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-xs-9 text-right">
            <?php
            $query = "SELECT * from tbl_news, tbl_image, tbl_news_category, tbl_employee where editorid = id and  email = '$username' and categoryID = newscat_id and img_id = image_id";
            $select_query = mysqli_query($connection, $query);
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-xs-9 text-right">
            <?php
            $query = "select * from tbl_news, tbl_employee, tbl_comments where newss_id = comment_news_id and email = '$username' and editorid = id";
            $select_query = mysqli_query($connection, $query);
