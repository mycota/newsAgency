...
<input class="form-control" id="myInput" type="text" placeholder="Search..">
  ...
  $page = $_GET['page'];
    ...
    $query_count = "SELECT * from tbl_draft_news, tbl_image, tbl_news_category, tbl_employee where email = '$username' and authorid = '$empid' and categoryID = newscat_id and imge_id = image_id and draft_status = 'Drafting'";
...
<table class="table table-bordered table-hover">
                  ...
                  <tbody id="myTable">
        <?php
  $query = "SELECT * from tbl_draft_news, tbl_image, tbl_news_category, tbl_employee where email = '$username' and authorid = id and categoryID = newscat_id and imge_id = image_id and draft_status = 'Drafting' order by draft_id desc LIMIT $page1,4";
