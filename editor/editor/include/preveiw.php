    ...
    <div class="container">
        ...
        <div class="row">
         ...
         <?php if(isset($_GET['did'])){
          ...
          $query = "SELECT  * from tbl_news, tbl_image, tbl_news_category, tbl_employee where editorid = id and categoryID = newscat_id and img_id = image_id and newss_id = '$nid'";
