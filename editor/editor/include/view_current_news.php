...
<input class="form-control" id="myInput" type="text" placeholder="Search..">
  ...
  $query_count = "SELECT * FROM tbl_news, tbl_image, tbl_news_category, tbl_employee where email = '$username' and editorid = id and categoryID = newscat_id and img_id = image_id and '$cdate' < end_date and '$cdate' > date_published";
...
<table class="table table-bordered table-hover">
  ...
  $cdate = date("Y-m-d");
  //echo "$cdate";
  $query = "SELECT DISTINCT * FROM tbl_news, tbl_image, tbl_news_category, tbl_employee where email = '$username' and editorid = id and categoryID = newscat_id and img_id = image_id and '$cdate' < end_date and '$cdate' > date_published order by newss_id LIMIT $page1,5";
